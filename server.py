...
app.add_url_rule("/hastanegoruntule", view_func=views.hastanegoruntule, methods=["GET", "POST"])
app.add_url_rule("/hastaneguncelleme", view_func=views.hastaneguncelleme, methods=["GET", "POST"])
